...
class HomeController extends Controller
{
    ...
    public function report()
    {
        ...
        $data['satu'] = DB::table('actions')->select('kata')->select('count(*) as total')->where('flag', '1')->where('search', '0')->where('valid', '1')->groupBy('kata')->orderBy('total', 'desc')->orderBy('created_at', 'asc')->orderBy('updated_at', 'asc')->orderBy('kata', 'asc')->limit(10)->get();
        dd($data);
